...
def open_calculator():
    ...
    top.iconbitmap("./iconos/2calculator.jpeg")
    # ventana_lapiz = Tk()
    top.geometry("600x350+100+100")
    # ventana_lapiz.title("Scientific Calculator By Brain Flicks")
    global switch
    switch = None
    ...
    disp = Entry(top, font="Verdana 20", fg="black", bg="mistyrose", bd=0, justify=RIGHT, insertbackground="#abbab1", cursor="arrow")
